...
public class PathFindingService {
    ...
    public PathFindingResponse findPath(PathFindingRequest request) {
        ...
        switch (request.getAlgorithm().toUpperCase()) {
            case "BFS":
                response = bfs(request.getTiles(), start, end, request.getHeight(), request.getWidth());
                break;
            case "DFS":
                response = dfs(request.getTiles(), start, end, request.getHeight(), request.getWidth());
                break;
            case "A_STAR":
                response = aStar(request.getTiles(), start, end, request.getHeight(), request.getWidth());
                break;
            case "IDS":
                response = ids(request.getTiles(), start, end, request.getHeight(), request.getWidth());
                break;
            default:
